...
<h3 align="center">Report 11AM: INCOMING TO SPOTTING  </h3>
...
<h3 align="center">Report 11AM: SPOTTING TO QC SCAN  </h3>
...
*/
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($challan['total_qc_ok']/$challan['total_spot'])*100; ?></td>
                                     <td><?php echo (($challan['total_spot']-$challan['total_qc_ok'])/$challan['total_spot'])*100;?></td>
...
<h3 align="center">Report 11AM: QC P-S TO PACK  </h3>
...
*/
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($challan['total_pack_ok']/$challan['total_qc'])*100; ?></td>
                                     <td><?php echo (($challan['total_qc']-$challan['total_pack_ok'])/$challan['total_qc'])*100;?></td>
