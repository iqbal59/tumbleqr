<style  type="text/css">
	...
	h3 ,h2 {text-align:center; margin: 0; margin-bottom:10px ; padding: 0;}
	.table { 
	width: 750px; 
...
<h2>Report Summary <?php echo date('d-m-Y', strtotime($dateData));?></h2>
<h3>Initial Total</h3>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td><?php echo $mtdinitial->totalmtd; ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
											...
											<td><?php echo $users[$challan['station_id']]; ?></td>
											<td><?php echo $challan['DC']; $dc+=$challan['DC'];?></td>
											<td><?php echo $challan['Laundry']; $l+=$challan['Laundry'];?></td>
											<td><?php echo $challan['total']; $t+=$challan['total'];?></td>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
											...
											<td><?php echo $users[$challan['station_id']]; ?></td>
											<td><?php echo $challan['total']; $t+=$challan['total']; ?></td>
											<td><?php echo $challan['fail_count'];$fc+=$challan['fail_count']; ?></td>
											<td><?php echo number_format(($challan['fail_count']/$challan['total'])*100, 2); ?></td>
											<td><?php echo $challan['sorry_count'];$sc+=$challan['sorry_count']; ?></td>
                                ...
                                <?php } ?>
                                 ...
                                 <tr>
											...
											<td><?php echo $t; ?></td>
											<td><?php echo $fc; ?></td>
											<td><?php echo number_format(($fc/$t)*100, 2); ?></td>
											<td><?php echo $sc ?></td>
											<td><?php echo number_format(($sc/$t)*100, 2); ?></td>
                    ...
                    <div class="table-responsive m-t-40">
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
<td><?php echo $users[$challan['qc_station_id']]; ?></td>
                                    <td><?php echo $challan['total']; ?></td>
                                    ...
                                    <td><?php echo number_format(($challan['fail_count']/$challan['total'])*100, 2); ?></td>
                                    <td><?php echo number_format(($challan['sorry_count']/$challan['total'])*100, 2); ?></td>
                                    <td><?php echo $repeat=$challan['total']-$challan['uniquebarcode']; ?></td>
                                    <td> <?php echo number_format((($repeat/$challan['total'])*100), 2);?></td>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $users[$challan['packing_station_id']]; ?></td>
                                                                        </td>
...
-->
                            ...
                            <tbody>
                                ...
                                <tr class="<?php echo $color; ?>">
                                    ...
                                    <td><?php echo date('d M y', strtotime($challan['Due_on'].' -1 days')); ?></td>

                                                                         
                                                                         <td><?php echo $due_order_count=$challan['total']-$challan['total_dispatch_all']+$challan['total_dispatch'];
                                        $td+=$due_order_count; ?></td>
<!--
                                                                         <td><?php echo $challan['total']; ?></td>
                                                                         
                                                                          <td><?php echo $challan['total_dispatch_all']; ?></td>
-->


                                                                         <td><?php echo $challan['total_dispatch'];
                                        $tdis+= $challan['total_dispatch']; ?></td>

                                                                         <td><?php  $v=number_format(($challan['total_dispatch']/$due_order_count)*100, 2);
                                        if ($v=='nan') {
                                            echo "0.00";
                                        } else {
                                            echo $v;
                                        ...
                                        $l+= $challan['Laundry']; ?></td>

                                                                         <td><?php echo $challan['laundry_dispatch'];
                                        $ld+= $challan['laundry_dispatch']; ?></td>
                                ...
                                <?php
                                   ...
                                   <tr>
	                                ...
	                                <td><?php echo  $td;?></td>
<td><?php echo  $tdis;?></td>		
<td><?php echo number_format(($tdis/$td)*100, 2);?></td>
<td><?php echo  $tdc;?></td>
<td><?php echo  $tdcd;?></td>
<td><?php echo number_format(($tdcd/$tdc)*100, 2);?></td>

<td><?php echo  $l;?></td>
<td><?php echo  $ld;?></td>
<td><?php echo number_format(($ld/$l)*100, 2); ?></td>

<td><?php echo  $s;?></td>
<td><?php echo  $sd;?></td>
<td><?php echo number_format(($sd/$s)*100, 2);?></td>
