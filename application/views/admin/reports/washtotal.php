...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Washing Total Report </h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Washing Total Report</li>
            </ol>
        </div>
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form method="get" class="m-0" action="<?php echo base_url('admin/reports/washall') ?>"
                                class="form-horizontal" novalidate>

                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <h5 class="text-white">From Date <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <h5 class="text-white">To Date <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="station_id" class="form-control">
                                                    ...
                                                    <?php
                                                       if(!empty($wash_stations)) {
                                                           foreach($wash_stations as $s) {
                                                               $selected='';
                                                               if(!empty($condition)) {
