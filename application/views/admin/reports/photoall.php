        ...
        <div class="col-12 pt-1">
            ...
            <div class="card card-outline-info mb-2">
                ...
                <div class="card-body py-1 pt-2">
                    <form method="get" action="<?php echo base_url('admin/reports/photoall') ?>" class="form-horizontal"
                        novalidate>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <table id="example23"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            style="display:none;"><?php echo strtotime($challan['Order_Date']); ?></span>
                                    ...
                                    <td><span
                                            style="display:none;"><?php echo strtotime($challan['photo_time']); ?></span>
                                        <?php echo date("d-m-Y H:i:s", strtotime($challan['photo_time'] . " +0 mins")); ?>
                                    </td>
