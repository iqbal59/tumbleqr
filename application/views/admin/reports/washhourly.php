...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Wash Hourly Report</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Wash Hourly Report</li>
            </ol>
        </div>
            ...
            <div class="card card-outline-info">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form method="get" class="mb-0" action="<?php echo base_url('admin/reports/wash') ?>"
