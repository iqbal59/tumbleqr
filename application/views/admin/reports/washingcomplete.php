...
<div class="container-fluid">
    ...
    <div class="row page-titles p-1">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Washing Garment Complete Report</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Washing Garment Complete Report</li>
            </ol>
        </div>
        ...
        <div class="col-12 pt-1">
            ...
            <div class="card card-outline-info mb-2">
                ...
                <form method="get" class="mb-0"
                                action="<?php echo base_url('admin/reports/washcomplete') ?>" class="form-horizontal"
                                novalidate>
                    <div class="form-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered table-sm"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span
                                        style="display:none;"><?php echo strtotime($challan['wash_start_time']);?></span><?php echo $challan['wash_start_time']; ?>
                                </td>
