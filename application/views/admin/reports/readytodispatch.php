...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="get"
                    action="<?php echo base_url('admin/reports/readytodispatch') ?>"
                    ...
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span style="display:none;"><?php echo strtotime($challan['Due_on']. ' - 1 days'); ?></span><?php echo date("d-m-Y", strtotime($challan['Due_on']. ' - 1 days')); ?>
                                </td>
                                <td>[ <a
