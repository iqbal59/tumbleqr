                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($condition)) {
                        if ($condition['filter_type']==1) {
                            echo "<h3 class='text-center'>Send to Workshop and Not Rececive at Plant</h3>";
                        } elseif ($condition['filter_type']==2) {
                            echo "<h3 class='text-center'>Not send to Workshop and Rececive at Plant</h3>";
                        } elseif ($condition['filter_type']==3) {
                            echo "<h3 class='text-center'>Not send to Workshop and Not Rececive at Plant</h3>";
                        }
                    }?>
