...
<div class="container-fluid">
    ...
    <div class="row page-titles p-1">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Initial Complete Report</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Initial Complete Report</li>
            </ol>
        </div>
                        ...
                        ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <h5>Services</h5>
                                                        <div class="controls">
                                                            <select name="services" class="form-control form-control-sm select2">
                                                                <option value="">--Select--</option>
                                                                <?php
                        if (!empty($services)) {
