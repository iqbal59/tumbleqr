        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /.modal -->
                    <img src="<?php echo base_url() ?>assets/images/alert/model2.png" alt="default" data-toggle="modal"
                        data-target=".bs-example-modal-lg" class="model_img img-responsive" />
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /.modal -->
                    <img src="<?php echo base_url() ?>assets/images/alert/model.png" alt="default" data-toggle="modal"
                        data-target="#myModal" class="model_img img-responsive" />
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /.modal -->
                    <img src="<?php echo base_url() ?>assets/images/alert/model3.png" alt="default" data-toggle="modal"
                        data-target=".bs-example-modal-sm" class="model_img img-responsive" />
                </div>
            </div>
        </div>
        <div class="col-md-4">
