    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Import Store Challan Data</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Import Store Challan Data <a
                            href="<?php echo base_url('admin/import/challandata');?>" class="btn btn-info pull-right"><i
                                class="fa fa-list"></i> All Challan Data </a></h4>

                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/import/importstoredata') ?>"
 ...
 <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3">Select Store <span
	                                                           ...
	                                                           <?php
		                                                           if(!empty($stores)){
			                                                           foreach($stores as $store){
				                                                           ...
				                                                           echo '<option value="'.$store['Store_Name'].'" '.$selected.'>'.$store['Store_Name'].'</option>';
			                                                           }
		                                                           }
		                                                           ?>
                                                           </select>
